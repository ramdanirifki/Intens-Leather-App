        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <button
                onClick={() => setNewArrivalsFilter("accessories")}
                className={`font-medium transition-colors ${
                  newArrivalsFilter === "accessories"
                    ? "text-gray-900 border-b-2 border-gray-900"
                    : "text-gray-500 hover:text-gray-900"
                }`}
              >
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Explore seasonal collections and styling inspiration crafted for
            purposeful living.
          </p>
          <Link
            to="/lookbook"
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
            At Intens.id, we believe in creating products that tell stories
            through time. Our commitment to authentic Indonesian craftsmanship
            and sustainable practices drives everything we do, from design to
            delivery.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Together, let's preserve the meaningful heritage of Indonesian
            craftsmanship. Every piece you choose not only brings beauty but
            also keeps the flame of local artisans' traditions burning bright
