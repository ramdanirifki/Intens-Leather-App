...
import AuthModal from "./AuthModal"; // Ganti LoginModal dengan AuthModal

const Header = () => {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  const [isAuthModalOpen, setIsAuthModalOpen] = useState(false); // Ganti nama state
  ...
  return (
    <>
      ...
      {/* Auth Modal - Ganti LoginModal dengan AuthModal */}
